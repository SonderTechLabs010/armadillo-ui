...
class WordSuggestionService {
  ...
  List<String> suggestWords(String input) {
    final suggestedWords = new List<String>.from(_kWords);
  ...
  int levenshteinDistance(String s, String t) {
    ...
    final v0 = new List<int>.filled(t.length + 1, 0);
    final v1 = new List<int>.filled(t.length + 1, 0);
